 ...
 */
class Http_HttpDispatcher_Test extends TestCase
{
  /**
   * @var HttpDispatcher
   */
  ...
  /**
   * @covers UGComponents\Http\HttpDispatcher::output
   */
  ...
  /**
   * @covers UGComponents\Http\HttpDispatcher::dispatch
   */
  ...
  /**
   * @covers UGComponents\Http\HttpDispatcher::redirect
   */
  ...
  /**
   * @covers UGComponents\Http\HttpDispatcher::isSuccessful
   */
