 ...
 */
class I18n_Language_Test extends TestCase
{
  /**
   * @var Language
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::__call
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::__construct
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::translate
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::getLanguage
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::save
   */
  public function testSave()
  {
    ...
    $this->assertInstanceOf('UGComponents\I18n\Language', $class);
  ...
  /**
   * @covers UGComponents\I18n\Language::define
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::offsetExists
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::offsetGet
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::offsetSet
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::offsetUnset
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::current
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::key
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::next
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::rewind
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::valid
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::__callData
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::__get
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::__getData
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::__set
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::__setData
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::__toString
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::__toStringData
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::generator
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::getEventEmitter
   */
  public function testGetEventEmitter()
  {
    ...
    $instance = $this->object
      ->setEventEmitter(new LanguageEventEmitterStub)
      ->getEventEmitter();
    $this->assertInstanceOf('UGComponents\I18n\LanguageEventEmitterStub', $instance);
  }

  /**
   * @covers UGComponents\I18n\Language::on
   */
  public function testOn()
  {
    ...
    $this->assertInstanceOf('UGComponents\I18n\Language', $instance);
    $this->assertTrue($trigger->success);
  }

  /**
   * @covers UGComponents\I18n\Language::setEventEmitter
   */
  public function testSetEventEmitter()
  {
    $instance = $this->object->setEventEmitter(new LanguageEventEmitterStub);
    $this->assertInstanceOf('UGComponents\I18n\Language', $instance);
  }
  ...
  /**
   * @covers UGComponents\I18n\Language::i
   */
  public function testI()
  {
    $instance1 = Language::i(array());
    $this->assertInstanceOf('UGComponents\I18n\Language', $instance1);
  ...
  /**
   * @covers UGComponents\I18n\Language::loop
   */
  public function testLoop()
  {
    $self = $this;
    $this->object->loop(function($i) use ($self) {
      $self->assertInstanceOf('UGComponents\I18n\Language', $this);
  ...
  /**
   * @covers UGComponents\I18n\Language::when
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::getInspectorHandler
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::inspect
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::setInspectorHandler
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::addLogger
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::log
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::loadState
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::saveState
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::__callResolver
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::addResolver
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::getResolverHandler
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::resolve
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::resolveShared
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::resolveStatic
   */
  ...
  /**
   * @covers UGComponents\I18n\Language::setResolverHandler
   */
...
if(!class_exists('UGComponents\I18n\LanguageEventEmitterStub')) {
  class LanguageEventEmitterStub extends EventEmitter
  {
  }
}

if(!class_exists('UGComponents\I18n\InspectorHandlerStub')) {
