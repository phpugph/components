 ...
 */
class InspectorTraitTest extends TestCase
{
  /**
   * @var InspectorTrait
   */
  ...
  {
    $instance = $this->object->setInspectorHandler(new InspectorHandlerStub2);
...
if(!class_exists('UGComponents\Profiler\InspectorHandlerStub2')) {
  class InspectorHandlerStub2 extends InspectorHandler
  {
  }
}
