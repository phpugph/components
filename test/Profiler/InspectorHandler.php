 ...
 */
class Profiler_InspectorHandler_Test extends TestCase
{
  /**
  ...
  public function test__call()
  {
    ...
    $this->assertEquals('<pre>INSPECTING UGComponents\Profiler\InspectorHandlerTest->:</pre><pre>4</pre>', $contents);
    ...
    $this->assertEquals(
      '<pre>INSPECTING UGComponents\Profiler\InspectorHandlerTest->:</pre><pre>5</pre>',
      $contents
    );
    ...
    $this->assertEquals(
      '<pre>INSPECTING UGComponents\Profiler\InspectorHandlerTest->x:</pre><pre>4</pre>',
      $contents
    );
  }
...
if(!class_exists('UGComponents\Profiler\InspectorHandlerTest')) {
