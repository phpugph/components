 ...
 */
class Resolver_StateTrait_Test extends TestCase
{
  /**
   * @var StateTrait
   */
  ...
  /**
   * @covers UGComponents\Resolver\StateTrait::loadState
   */
  ...
  /**
   * @covers UGComponents\Resolver\StateTrait::saveState
   */
  ...
  /**
   * @covers UGComponents\Resolver\StateTrait::__callResolver
   */
  public function test__callResolver()
  {
    $actual = $this->object->addResolver(ResolverCallStub::class, function() {});
    $this->assertInstanceOf('UGComponents\Resolver\StateTraitStub', $actual);
  }

  /**
   * @covers UGComponents\Resolver\StateTrait::addResolver
   */
  ...
  /**
   * @covers UGComponents\Resolver\StateTrait::getResolverHandler
   */
  ...
  /**
   * @covers UGComponents\Resolver\StateTrait::resolve
   */
  ...
  /**
   * @covers UGComponents\Resolver\StateTrait::resolveShared
   */
  ...
  /**
   * @covers UGComponents\Resolver\StateTrait::resolveStatic
   */
  ...
  /**
   * @covers UGComponents\Resolver\StateTrait::setResolverHandler
   */
...
if(!class_exists('UGComponents\Resolver\StateTraitStub')) {
